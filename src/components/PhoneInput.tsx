...
// African countries supported — add more as the project expands
...
export interface PhoneValue {
  ...
  digits: string;     // local digits without country code
  full: string;       // e.g. "+2519XXXXXXXX"
  isValid: boolean;
}

interface Props {
  onChange: (value: PhoneValue) => void;
  defaultCountryCode?: string; // e.g. 'NG'
  error?: boolean;
  valid?: boolean;
}
